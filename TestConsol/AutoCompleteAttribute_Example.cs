...
namespace TestConsol
{
    ...
    class AutoCompleteAttribute_Example : ServicedComponent
    {
        [AutoComplete]
        ...
        {   
            ...
            AutoCompleteAttribute attribute = (AutoCompleteAttribute)System.Attribute.GetCustomAttribute(
                memberinfo[0],
                typeof(AutoCompleteAttribute_Example),
                false);
